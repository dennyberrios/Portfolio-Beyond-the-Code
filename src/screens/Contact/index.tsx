...
const ContactPage = () => {
    return (
        <>
            ...
            <p className="text-dark-grey lg:text-xl max-lg:text-lg max-sm:text-base mb-5 text-center px-2">Estou sempre aberto a novas oportunidades e parcerias. Conecte-se comigo nas redes sociais ou envie uma mensagem.</p>
            ...
            <section className="bg-dark-blue-gray w-full flex justify-center items-center flex-col">
                ...
                <p className="text-light-bg lg:text-xl max-lg:text-lg max-sm:text-base text-center px-2">Tem um projeto em mente ou quer apenas trocar uma ideia? <br/> Preencha o formulário abaixo!</p>
                <FormContact />
            </section>
        </>
    );
