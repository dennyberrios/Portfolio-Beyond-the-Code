    ...
    return (
        <>
            <section className="flex justify-center items-center flex-col text-center px-5 py-20 lg:w-[1000px] max-lg:w-[800px] max-md:w-[640px] max-sm:w-11/12 gap-3">
                <div className="flex gap-10 max-sm:flex-col min-sm:flex max-sm:items-center">
                    {ImgDannyBerrios && (
                        <Image
                            src={ImgDannyBerrios}
                            alt="Foto de Danny Berrios"
                            className="lg:w-80 max-lg:w-80 h-[380px] mt-16 min-sm:order-1 max-sm:order-0 rounded-md mb-0 shadow-md shadow-slate-500"
                        />
                    )}
                    <div>
                        ...
                        <p className="text-dark-grey text-justify mb-3 lg:text-xl max-lg:text-lg max-sm:text-base">
                        ...
                        <p className="text-dark-grey text-justify lg:text-xl max-lg:text-lg max-sm:text-base">
