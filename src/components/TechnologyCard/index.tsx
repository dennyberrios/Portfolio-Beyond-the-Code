...
const TechnologyCard: React.FC<TTechnologyCard> = ({image, title, description}) => {
    return ( 
        <div className='w-[300px] hover:rotate-6 flex flex-col justify-center items-center rounded-xl bg-light-blue hover:shadow-lg p-5 hover:-translate-y-4 transition duration-300 ease-in-out brightness-90 hover:brightness-100'>
